// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\DATA_MEMORY_block.v
...
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter3/LineBuffer/DATA_MEMORY
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DATA_MEMORY_block
  ...
  input   enb;
  input   Unloading;
  input   [19:0] pixelIn;  // ufix20_En12
  input   hStartIn;
  input   hEndIn;
  input   vStartIn;
  input   vEndIn;
  ...
  wire [19:0] pixelColumn_0;  // ufix20_En12
  reg [19:0] pixelColumnO1;  // ufix20_En12
  reg  validREG;
  reg  unloadPop;
  reg  hEndREG;
  reg  hEndREGT;
  ...
  wire popFIFO_2;
  wire EndofLine1;
  wire [19:0] pixelColumn1;  // ufix20_En12
  wire PopEnSL_1;
  ...
  reg  pushOutREG2;
  wire [19:0] pixelColumn2;  // ufix20_En12
  reg  popOut_1;
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_process
      if (reset == 1'b1) begin
        pixelColumnO1 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  PushPopCounterOne_block u_PushPopCounterOne (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
                                               .hStartIn(hStartIn),
                                               .popIn(validPop),
  ...
  PushPopCounter_block u_PushPopCounter2 (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .hStartIn(hStartIn),
                                          .popIn(validPop),
