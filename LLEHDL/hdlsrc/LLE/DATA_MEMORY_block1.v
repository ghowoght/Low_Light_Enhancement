// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\DATA_MEMORY_block1.v
...
// -------------------------------------------------------------
// 
// Module: DATA_MEMORY_block1
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter2/LineBuffer/DATA_MEMORY
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DATA_MEMORY_block1
  ...
  output  [15:0] dataVectorOut_0;  // ufix16_En8
  output  [15:0] dataVectorOut_1;  // ufix16_En8
  output  [15:0] dataVectorOut_2;  // ufix16_En8
  output  popOut;
  output  AllAtEnd;
  ...
  wire [15:0] pixelColumn_0;  // ufix16_En8
  reg [15:0] pixelColumnO1;  // ufix16_En8
  reg  validREG;
  reg  unloadPop;
  reg  hEndREG;
  reg  hEndREGT;
  ...
  wire popFIFO_2;
  wire EndofLine1;
  wire [15:0] pixelColumn1;  // ufix16_En8
  wire PopEnSL_1;
  ...
  reg  pushOutREG2;
  wire [15:0] pixelColumn2;  // ufix16_En8
  reg  popOut_1;
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_process
      if (reset == 1'b1) begin
        pixelColumnO1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  PushPopCounterOne_block1 u_PushPopCounterOne (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .hStartIn(hStartIn),
                                                .popIn(validPop),
  ...
  PushPopCounter_block1 u_PushPopCounter2 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .hStartIn(hStartIn),
                                           .popIn(validPop),
