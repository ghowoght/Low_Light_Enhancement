// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\DATA_MEMORY_block3.v
...
// -------------------------------------------------------------
// 
// Module: DATA_MEMORY_block3
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter/LineBuffer/DATA_MEMORY
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DATA_MEMORY_block3
  ...
  PushPopCounterOne_block3 u_PushPopCounterOne (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .hStartIn(hStartIn),
                                                .popIn(validPop),
  ...
  PushPopCounter_block3 u_PushPopCounter2 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .hStartIn(hStartIn),
                                           .popIn(validPop),
