// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\FIR2DKernel_block.v
...
// -------------------------------------------------------------
// 
// Module: FIR2DKernel_block
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter3/FIR2DKernel
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module FIR2DKernel_block
  ...
  input   reset;
  input   enb;
  input   [19:0] dataIn_0;  // ufix20_En12
  input   [19:0] dataIn_1;  // ufix20_En12
  input   [19:0] dataIn_2;  // ufix20_En12
  input   vStartIn;
  input   vEndIn;
  input   hStartIn;
  input   hEndIn;
  input   validIn;
  input   processData;
  output  [23:0] dataOut;  // ufix24_En16
  output  vStartOut;
  output  vEndOut;
  output  hStartOut;
  output  hEndOut;
  ...
  reg [19:0] tapDelay_1_reg [0:1];  // ufix20 [2]
  wire [19:0] tapDelay_1_reg_next [0:1];  // ufix20_En12 [2]
  wire [19:0] tapOutData_1 [0:2];  // ufix20_En12 [3]
  wire [19:0] tapOutData_1_0;  // ufix20_En12
  reg [19:0] preAdd1_stage1_1;  // ufix20_En12
  reg [19:0] tapDelay_3_reg [0:1];  // ufix20 [2]
  wire [19:0] tapDelay_3_reg_next [0:1];  // ufix20_En12 [2]
  wire [19:0] tapOutData_3 [0:2];  // ufix20_En12 [3]
  wire [19:0] tapOutData_3_0;  // ufix20_En12
  reg [19:0] preAdd1_stage1_2;  // ufix20_En12
  wire [20:0] adder_add_cast;  // ufix21_En12
  wire [20:0] adder_add_cast_1;  // ufix21_En12
  wire [20:0] preAdd1_stage1_add_1;  // ufix21_En12
  reg [20:0] preAdd1_stage2_1;  // ufix21_En12
  wire [19:0] tapOutData_1_2;  // ufix20_En12
  reg [19:0] preAdd1_stage1_3;  // ufix20_En12
  wire [19:0] tapOutData_3_2;  // ufix20_En12
  reg [19:0] preAdd1_stage1_4;  // ufix20_En12
  wire [20:0] adder_add_cast_2;  // ufix21_En12
  wire [20:0] adder_add_cast_3;  // ufix21_En12
  wire [20:0] preAdd1_stage1_add_2;  // ufix21_En12
  reg [20:0] preAdd1_stage2_2;  // ufix21_En12
  wire [21:0] adder_add_cast_4;  // ufix22_En12
  wire [21:0] adder_add_cast_5;  // ufix22_En12
  wire [21:0] preAdd1_stage2_add_1;  // ufix22_En12
  reg [21:0] preAdd1_final_reg;  // ufix22_En12
  reg [21:0] multInDelay1_reg [0:1];  // ufix22 [2]
  wire [21:0] multInDelay1_reg_next [0:1];  // ufix22_En12 [2]
  wire [21:0] multInReg1;  // ufix22_En12
  wire [25:0] multOut1;  // ufix26_En16
  reg [25:0] multOutDelay1_reg [0:1];  // ufix26 [2]
  wire [25:0] multOutDelay1_reg_next [0:1];  // ufix26_En16 [2]
  wire [25:0] multOutReg1;  // ufix26_En16
  reg [25:0] add_stage1_1;  // ufix26_En16
  reg [19:0] tapDelay_2_reg [0:1];  // ufix20 [2]
  wire [19:0] tapDelay_2_reg_next [0:1];  // ufix20_En12 [2]
  wire [19:0] tapOutData_2 [0:2];  // ufix20_En12 [3]
  wire [19:0] tapOutData_2_0;  // ufix20_En12
  reg [19:0] preAdd2_stage1_1;  // ufix20_En12
  wire [19:0] tapOutData_1_1;  // ufix20_En12
  reg [19:0] preAdd2_stage1_2;  // ufix20_En12
  wire [20:0] adder_add_cast_6;  // ufix21_En12
  wire [20:0] adder_add_cast_7;  // ufix21_En12
  wire [20:0] preAdd2_stage1_add_1;  // ufix21_En12
  reg [20:0] preAdd2_stage2_1;  // ufix21_En12
  wire [19:0] tapOutData_3_1;  // ufix20_En12
  reg [19:0] preAdd2_stage1_3;  // ufix20_En12
  wire [19:0] tapOutData_2_2;  // ufix20_En12
  reg [19:0] preAdd2_stage1_4;  // ufix20_En12
  wire [20:0] adder_add_cast_8;  // ufix21_En12
  wire [20:0] adder_add_cast_9;  // ufix21_En12
  wire [20:0] preAdd2_stage1_add_2;  // ufix21_En12
  reg [20:0] preAdd2_stage2_2;  // ufix21_En12
  wire [21:0] adder_add_cast_10;  // ufix22_En12
  wire [21:0] adder_add_cast_11;  // ufix22_En12
  wire [21:0] preAdd2_stage2_add_1;  // ufix22_En12
  reg [21:0] preAdd2_final_reg;  // ufix22_En12
  reg [21:0] multInDelay2_reg [0:1];  // ufix22 [2]
  wire [21:0] multInDelay2_reg_next [0:1];  // ufix22_En12 [2]
  wire [21:0] multInReg2;  // ufix22_En12
  wire [25:0] multOut2;  // ufix26_En16
  reg [25:0] multOutDelay2_reg [0:1];  // ufix26 [2]
  wire [25:0] multOutDelay2_reg_next [0:1];  // ufix26_En16 [2]
  wire [25:0] multOutReg2;  // ufix26_En16
  reg [25:0] add_stage1_2;  // ufix26_En16
  wire [26:0] adder_add_cast_12;  // ufix27_En16
  wire [26:0] adder_add_cast_13;  // ufix27_En16
  wire [26:0] add_stage1_add_1;  // ufix27_En16
  reg [26:0] add_stage2_1;  // ufix27_En16
  wire [19:0] tapOutData_2_1;  // ufix20_En12
  reg [19:0] preAdd3_balance_reg [0:2];  // ufix20 [3]
  wire [19:0] preAdd3_balance_reg_next [0:2];  // ufix20_En12 [3]
  wire [19:0] preAdd3_balance_reg_1;  // ufix20_En12
  reg [19:0] multInDelay3_reg [0:1];  // ufix20 [2]
  wire [19:0] multInDelay3_reg_next [0:1];  // ufix20_En12 [2]
  wire [19:0] multInReg3;  // ufix20_En12
  wire [23:0] multOut3;  // ufix24_En16
  reg [23:0] multOutDelay3_reg [0:1];  // ufix24 [2]
  wire [23:0] multOutDelay3_reg_next [0:1];  // ufix24_En16 [2]
  wire [23:0] multOutReg3;  // ufix24_En16
  reg [23:0] add_stage2_2_reg_reg [0:1];  // ufix24 [2]
  wire [23:0] add_stage2_2_reg_reg_next [0:1];  // ufix24_En16 [2]
  wire [23:0] add_stage2_2;  // ufix24_En16
  wire [27:0] adder_add_cast_14;  // ufix28_En16
  wire [27:0] adder_add_cast_15;  // ufix28_En16
  wire [27:0] add_stage2_add_1;  // ufix28_En16
  reg [27:0] add_final_reg;  // ufix28_En16
  wire [23:0] add_final_reg_conv;  // ufix24_En16
  reg [23:0] dataOut_2;  // ufix24_En16
  reg  vStartIn_reg;
  ...
  always @(posedge clk or posedge reset)
    begin : tapDelay_1_process
      if (reset == 1'b1) begin
        tapDelay_1_reg[0] <= 20'b00000000000000000000;
        tapDelay_1_reg[1] <= 20'b00000000000000000000;
      end
      else begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_1_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage1_1 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : tapDelay_3_process
      if (reset == 1'b1) begin
        tapDelay_3_reg[0] <= 20'b00000000000000000000;
        tapDelay_3_reg[1] <= 20'b00000000000000000000;
      end
      else begin
        if (enb && processData) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_2_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage1_2 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage2_1_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage2_1 <= 21'b000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_3_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage1_3 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_4_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage1_4 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage2_2_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage2_2 <= 21'b000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_final_process
      if (reset == 1'b1) begin
        preAdd1_final_reg <= 22'b0000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay1_process
      if (reset == 1'b1) begin
        multInDelay1_reg[0] <= 22'b0000000000000000000000;
        multInDelay1_reg[1] <= 22'b0000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay1_process
      if (reset == 1'b1) begin
        multOutDelay1_reg[0] <= 26'b00000000000000000000000000;
        multOutDelay1_reg[1] <= 26'b00000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage1_1_reg_process
      if (reset == 1'b1) begin
        add_stage1_1 <= 26'b00000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : tapDelay_2_process
      if (reset == 1'b1) begin
        tapDelay_2_reg[0] <= 20'b00000000000000000000;
        tapDelay_2_reg[1] <= 20'b00000000000000000000;
      end
      else begin
        if (enb && processData) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage1_1_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage1_1 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage1_2_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage1_2 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage2_1_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage2_1 <= 21'b000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage1_3_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage1_3 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage1_4_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage1_4 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage2_2_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage2_2 <= 21'b000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_final_process
      if (reset == 1'b1) begin
        preAdd2_final_reg <= 22'b0000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay2_process
      if (reset == 1'b1) begin
        multInDelay2_reg[0] <= 22'b0000000000000000000000;
        multInDelay2_reg[1] <= 22'b0000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay2_process
      if (reset == 1'b1) begin
        multOutDelay2_reg[0] <= 26'b00000000000000000000000000;
        multOutDelay2_reg[1] <= 26'b00000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage1_2_reg_process
      if (reset == 1'b1) begin
        add_stage1_2 <= 26'b00000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage2_1_reg_process
      if (reset == 1'b1) begin
        add_stage2_1 <= 27'b000000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd3_balance_process
      if (reset == 1'b1) begin
        preAdd3_balance_reg[0] <= 20'b00000000000000000000;
        preAdd3_balance_reg[1] <= 20'b00000000000000000000;
        preAdd3_balance_reg[2] <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay3_process
      if (reset == 1'b1) begin
        multInDelay3_reg[0] <= 20'b00000000000000000000;
        multInDelay3_reg[1] <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay3_process
      if (reset == 1'b1) begin
        multOutDelay3_reg[0] <= 24'b000000000000000000000000;
        multOutDelay3_reg[1] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage2_2_reg_process
      if (reset == 1'b1) begin
        add_stage2_2_reg_reg[0] <= 24'b000000000000000000000000;
        add_stage2_2_reg_reg[1] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_final_process
      if (reset == 1'b1) begin
        add_final_reg <= 28'b0000000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign add_final_reg_conv = (add_final_reg[27:24] != 4'b0000 ? 24'b111111111111111111111111 :
              add_final_reg[23:0]);
  ...
  always @(posedge clk or posedge reset)
    begin : dataOut_1_process
      if (reset == 1'b1) begin
        dataOut_2 <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
