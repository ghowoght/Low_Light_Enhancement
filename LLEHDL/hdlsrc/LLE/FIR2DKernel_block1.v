// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\FIR2DKernel_block1.v
...
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter2/FIR2DKernel
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module FIR2DKernel_block1
  ...
  input   reset;
  input   enb;
  input   [15:0] dataIn_0;  // ufix16_En8
  input   [15:0] dataIn_1;  // ufix16_En8
  input   [15:0] dataIn_2;  // ufix16_En8
  input   vStartIn;
  input   vEndIn;
  input   hStartIn;
  input   hEndIn;
  input   validIn;
  input   processData;
  output  [19:0] dataOut;  // ufix20_En12
  output  vStartOut;
  output  vEndOut;
  output  hStartOut;
  output  hEndOut;
  ...
  reg [15:0] tapDelay_1_reg [0:1];  // ufix16 [2]
  wire [15:0] tapDelay_1_reg_next [0:1];  // ufix16_En8 [2]
  wire [15:0] tapOutData_1 [0:2];  // ufix16_En8 [3]
  wire [15:0] tapOutData_1_0;  // ufix16_En8
  reg [15:0] preAdd1_stage1_1;  // ufix16_En8
  reg [15:0] tapDelay_3_reg [0:1];  // ufix16 [2]
  wire [15:0] tapDelay_3_reg_next [0:1];  // ufix16_En8 [2]
  wire [15:0] tapOutData_3 [0:2];  // ufix16_En8 [3]
  wire [15:0] tapOutData_3_0;  // ufix16_En8
  reg [15:0] preAdd1_stage1_2;  // ufix16_En8
  wire [16:0] adder_add_cast;  // ufix17_En8
  wire [16:0] adder_add_cast_1;  // ufix17_En8
  wire [16:0] preAdd1_stage1_add_1;  // ufix17_En8
  reg [16:0] preAdd1_stage2_1;  // ufix17_En8
  wire [15:0] tapOutData_1_2;  // ufix16_En8
  reg [15:0] preAdd1_stage1_3;  // ufix16_En8
  wire [15:0] tapOutData_3_2;  // ufix16_En8
  reg [15:0] preAdd1_stage1_4;  // ufix16_En8
  wire [16:0] adder_add_cast_2;  // ufix17_En8
  wire [16:0] adder_add_cast_3;  // ufix17_En8
  wire [16:0] preAdd1_stage1_add_2;  // ufix17_En8
  reg [16:0] preAdd1_stage2_2;  // ufix17_En8
  wire [17:0] adder_add_cast_4;  // ufix18_En8
  wire [17:0] adder_add_cast_5;  // ufix18_En8
  wire [17:0] preAdd1_stage2_add_1;  // ufix18_En8
  reg [17:0] preAdd1_final_reg;  // ufix18_En8
  reg [17:0] multInDelay1_reg [0:1];  // ufix18 [2]
  wire [17:0] multInDelay1_reg_next [0:1];  // ufix18_En8 [2]
  wire [17:0] multInReg1;  // ufix18_En8
  wire [21:0] multOut1;  // ufix22_En12
  reg [21:0] multOutDelay1_reg [0:1];  // ufix22 [2]
  wire [21:0] multOutDelay1_reg_next [0:1];  // ufix22_En12 [2]
  wire [21:0] multOutReg1;  // ufix22_En12
  reg [21:0] add_stage1_1;  // ufix22_En12
  reg [15:0] tapDelay_2_reg [0:1];  // ufix16 [2]
  wire [15:0] tapDelay_2_reg_next [0:1];  // ufix16_En8 [2]
  wire [15:0] tapOutData_2 [0:2];  // ufix16_En8 [3]
  wire [15:0] tapOutData_2_0;  // ufix16_En8
  reg [15:0] preAdd2_stage1_1;  // ufix16_En8
  wire [15:0] tapOutData_1_1;  // ufix16_En8
  reg [15:0] preAdd2_stage1_2;  // ufix16_En8
  wire [16:0] adder_add_cast_6;  // ufix17_En8
  wire [16:0] adder_add_cast_7;  // ufix17_En8
  wire [16:0] preAdd2_stage1_add_1;  // ufix17_En8
  reg [16:0] preAdd2_stage2_1;  // ufix17_En8
  wire [15:0] tapOutData_3_1;  // ufix16_En8
  reg [15:0] preAdd2_stage1_3;  // ufix16_En8
  wire [15:0] tapOutData_2_2;  // ufix16_En8
  reg [15:0] preAdd2_stage1_4;  // ufix16_En8
  wire [16:0] adder_add_cast_8;  // ufix17_En8
  wire [16:0] adder_add_cast_9;  // ufix17_En8
  wire [16:0] preAdd2_stage1_add_2;  // ufix17_En8
  reg [16:0] preAdd2_stage2_2;  // ufix17_En8
  wire [17:0] adder_add_cast_10;  // ufix18_En8
  wire [17:0] adder_add_cast_11;  // ufix18_En8
  wire [17:0] preAdd2_stage2_add_1;  // ufix18_En8
  reg [17:0] preAdd2_final_reg;  // ufix18_En8
  reg [17:0] multInDelay2_reg [0:1];  // ufix18 [2]
  wire [17:0] multInDelay2_reg_next [0:1];  // ufix18_En8 [2]
  wire [17:0] multInReg2;  // ufix18_En8
  wire [21:0] multOut2;  // ufix22_En12
  reg [21:0] multOutDelay2_reg [0:1];  // ufix22 [2]
  wire [21:0] multOutDelay2_reg_next [0:1];  // ufix22_En12 [2]
  wire [21:0] multOutReg2;  // ufix22_En12
  reg [21:0] add_stage1_2;  // ufix22_En12
  wire [22:0] adder_add_cast_12;  // ufix23_En12
  wire [22:0] adder_add_cast_13;  // ufix23_En12
  wire [22:0] add_stage1_add_1;  // ufix23_En12
  reg [22:0] add_stage2_1;  // ufix23_En12
  wire [15:0] tapOutData_2_1;  // ufix16_En8
  reg [15:0] preAdd3_balance_reg [0:2];  // ufix16 [3]
  wire [15:0] preAdd3_balance_reg_next [0:2];  // ufix16_En8 [3]
  wire [15:0] preAdd3_balance_reg_1;  // ufix16_En8
  reg [15:0] multInDelay3_reg [0:1];  // ufix16 [2]
  wire [15:0] multInDelay3_reg_next [0:1];  // ufix16_En8 [2]
  wire [15:0] multInReg3;  // ufix16_En8
  wire [19:0] multOut3;  // ufix20_En12
  reg [19:0] multOutDelay3_reg [0:1];  // ufix20 [2]
  wire [19:0] multOutDelay3_reg_next [0:1];  // ufix20_En12 [2]
  wire [19:0] multOutReg3;  // ufix20_En12
  reg [19:0] add_stage2_2_reg_reg [0:1];  // ufix20 [2]
  wire [19:0] add_stage2_2_reg_reg_next [0:1];  // ufix20_En12 [2]
  wire [19:0] add_stage2_2;  // ufix20_En12
  wire [23:0] adder_add_cast_14;  // ufix24_En12
  wire [23:0] adder_add_cast_15;  // ufix24_En12
  wire [23:0] add_stage2_add_1;  // ufix24_En12
  reg [23:0] add_final_reg;  // ufix24_En12
  wire [19:0] add_final_reg_conv;  // ufix20_En12
  reg [19:0] dataOut_2;  // ufix20_En12
  reg  vStartIn_reg;
  ...
  always @(posedge clk or posedge reset)
    begin : tapDelay_1_process
      if (reset == 1'b1) begin
        tapDelay_1_reg[0] <= 16'b0000000000000000;
        tapDelay_1_reg[1] <= 16'b0000000000000000;
      end
      else begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_1_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : tapDelay_3_process
      if (reset == 1'b1) begin
        tapDelay_3_reg[0] <= 16'b0000000000000000;
        tapDelay_3_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb && processData) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_2_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage1_2 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage2_1_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage2_1 <= 17'b00000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_3_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage1_3 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_4_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage1_4 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage2_2_reg_process
      if (reset == 1'b1) begin
        preAdd1_stage2_2 <= 17'b00000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_final_process
      if (reset == 1'b1) begin
        preAdd1_final_reg <= 18'b000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay1_process
      if (reset == 1'b1) begin
        multInDelay1_reg[0] <= 18'b000000000000000000;
        multInDelay1_reg[1] <= 18'b000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay1_process
      if (reset == 1'b1) begin
        multOutDelay1_reg[0] <= 22'b0000000000000000000000;
        multOutDelay1_reg[1] <= 22'b0000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage1_1_reg_process
      if (reset == 1'b1) begin
        add_stage1_1 <= 22'b0000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : tapDelay_2_process
      if (reset == 1'b1) begin
        tapDelay_2_reg[0] <= 16'b0000000000000000;
        tapDelay_2_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb && processData) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage1_1_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage1_2_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage1_2 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage2_1_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage2_1 <= 17'b00000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage1_3_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage1_3 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage1_4_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage1_4 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_stage2_2_reg_process
      if (reset == 1'b1) begin
        preAdd2_stage2_2 <= 17'b00000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_final_process
      if (reset == 1'b1) begin
        preAdd2_final_reg <= 18'b000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay2_process
      if (reset == 1'b1) begin
        multInDelay2_reg[0] <= 18'b000000000000000000;
        multInDelay2_reg[1] <= 18'b000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay2_process
      if (reset == 1'b1) begin
        multOutDelay2_reg[0] <= 22'b0000000000000000000000;
        multOutDelay2_reg[1] <= 22'b0000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage1_2_reg_process
      if (reset == 1'b1) begin
        add_stage1_2 <= 22'b0000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage2_1_reg_process
      if (reset == 1'b1) begin
        add_stage2_1 <= 23'b00000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd3_balance_process
      if (reset == 1'b1) begin
        preAdd3_balance_reg[0] <= 16'b0000000000000000;
        preAdd3_balance_reg[1] <= 16'b0000000000000000;
        preAdd3_balance_reg[2] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay3_process
      if (reset == 1'b1) begin
        multInDelay3_reg[0] <= 16'b0000000000000000;
        multInDelay3_reg[1] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay3_process
      if (reset == 1'b1) begin
        multOutDelay3_reg[0] <= 20'b00000000000000000000;
        multOutDelay3_reg[1] <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage2_2_reg_process
      if (reset == 1'b1) begin
        add_stage2_2_reg_reg[0] <= 20'b00000000000000000000;
        add_stage2_2_reg_reg[1] <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_final_process
      if (reset == 1'b1) begin
        add_final_reg <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign add_final_reg_conv = (add_final_reg[23:20] != 4'b0000 ? 20'b11111111111111111111 :
              add_final_reg[19:0]);
  ...
  always @(posedge clk or posedge reset)
    begin : dataOut_1_process
      if (reset == 1'b1) begin
        dataOut_2 <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
