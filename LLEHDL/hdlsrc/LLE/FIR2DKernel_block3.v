// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\FIR2DKernel_block3.v
...
// -------------------------------------------------------------
// 
// Module: FIR2DKernel_block3
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter/FIR2DKernel
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module FIR2DKernel_block3
  ...
  input   validIn;
  input   processData;
  output  [11:0] dataOut;  // ufix12_En4
  output  vStartOut;
  output  vEndOut;
  output  hStartOut;
  output  hEndOut;
  ...
  reg [7:0] tapDelay_1_reg [0:1];  // ufix8 [2]
  wire [7:0] tapDelay_1_reg_next [0:1];  // ufix8 [2]
  wire [7:0] tapOutData_1 [0:2];  // uint8 [3]
  wire [7:0] tapOutData_1_0;  // uint8
  reg [7:0] preAdd1_stage1_1;  // uint8
  reg [7:0] tapDelay_3_reg [0:1];  // ufix8 [2]
  wire [7:0] tapDelay_3_reg_next [0:1];  // ufix8 [2]
  wire [7:0] tapOutData_3 [0:2];  // uint8 [3]
  wire [7:0] tapOutData_3_0;  // uint8
  reg [7:0] preAdd1_stage1_2;  // uint8
  wire [8:0] adder_1;  // ufix9
  wire [8:0] adder_2;  // ufix9
  wire [8:0] preAdd1_stage1_add_1;  // ufix9
  reg [8:0] preAdd1_stage2_1;  // ufix9
  wire [7:0] tapOutData_1_2;  // uint8
  reg [7:0] preAdd1_stage1_3;  // uint8
  wire [7:0] tapOutData_3_2;  // uint8
  reg [7:0] preAdd1_stage1_4;  // uint8
  wire [8:0] adder_4;  // ufix9
  wire [8:0] adder_5;  // ufix9
  wire [8:0] preAdd1_stage1_add_2;  // ufix9
  reg [8:0] preAdd1_stage2_2;  // ufix9
  wire [9:0] adder_7;  // ufix10
  wire [9:0] adder_8;  // ufix10
  wire [9:0] preAdd1_stage2_add_1;  // ufix10
  reg [9:0] preAdd1_final_reg;  // ufix10
  reg [9:0] multInDelay1_reg [0:1];  // ufix10 [2]
  wire [9:0] multInDelay1_reg_next [0:1];  // ufix10 [2]
  wire [9:0] multInReg1;  // ufix10
  wire [13:0] multOut1;  // ufix14_En4
  reg [13:0] multOutDelay1_reg [0:1];  // ufix14 [2]
  wire [13:0] multOutDelay1_reg_next [0:1];  // ufix14_En4 [2]
  wire [13:0] multOutReg1;  // ufix14_En4
  reg [13:0] add_stage1_1;  // ufix14_En4
  ...
  reg [7:0] preAdd2_stage1_1;  // uint8
  wire [7:0] tapOutData_1_1;  // uint8
  reg [7:0] preAdd2_stage1_2;  // uint8
  wire [8:0] adder_10;  // ufix9
  wire [8:0] adder_11;  // ufix9
  wire [8:0] preAdd2_stage1_add_1;  // ufix9
  reg [8:0] preAdd2_stage2_1;  // ufix9
  wire [7:0] tapOutData_3_1;  // uint8
  reg [7:0] preAdd2_stage1_3;  // uint8
  wire [7:0] tapOutData_2_2;  // uint8
  reg [7:0] preAdd2_stage1_4;  // uint8
  wire [8:0] adder_13;  // ufix9
  wire [8:0] adder_14;  // ufix9
  wire [8:0] preAdd2_stage1_add_2;  // ufix9
  reg [8:0] preAdd2_stage2_2;  // ufix9
  wire [9:0] adder_16;  // ufix10
  wire [9:0] adder_17;  // ufix10
  wire [9:0] preAdd2_stage2_add_1;  // ufix10
  reg [9:0] preAdd2_final_reg;  // ufix10
  reg [9:0] multInDelay2_reg [0:1];  // ufix10 [2]
  wire [9:0] multInDelay2_reg_next [0:1];  // ufix10 [2]
  wire [9:0] multInReg2;  // ufix10
  wire [13:0] multOut2;  // ufix14_En4
  reg [13:0] multOutDelay2_reg [0:1];  // ufix14 [2]
  wire [13:0] multOutDelay2_reg_next [0:1];  // ufix14_En4 [2]
  wire [13:0] multOutReg2;  // ufix14_En4
  reg [13:0] add_stage1_2;  // ufix14_En4
  wire [14:0] adder_add_cast;  // ufix15_En4
  wire [14:0] adder_add_cast_1;  // ufix15_En4
  wire [14:0] add_stage1_add_1;  // ufix15_En4
  reg [14:0] add_stage2_1;  // ufix15_En4
  wire [7:0] tapOutData_2_1;  // uint8
  reg [7:0] preAdd3_balance_reg [0:2];  // ufix8 [3]
  wire [7:0] preAdd3_balance_reg_next [0:2];  // ufix8 [3]
  wire [7:0] preAdd3_balance_reg_1;  // uint8
  reg [7:0] multInDelay3_reg [0:1];  // ufix8 [2]
  wire [7:0] multInDelay3_reg_next [0:1];  // ufix8 [2]
  wire [7:0] multInReg3;  // uint8
  wire [11:0] multOut3;  // ufix12_En4
  reg [11:0] multOutDelay3_reg [0:1];  // ufix12 [2]
  wire [11:0] multOutDelay3_reg_next [0:1];  // ufix12_En4 [2]
  wire [11:0] multOutReg3;  // ufix12_En4
  reg [11:0] add_stage2_2_reg_reg [0:1];  // ufix12 [2]
  wire [11:0] add_stage2_2_reg_reg_next [0:1];  // ufix12_En4 [2]
  wire [11:0] add_stage2_2;  // ufix12_En4
  wire [15:0] adder_add_cast_2;  // ufix16_En4
  wire [15:0] adder_add_cast_3;  // ufix16_En4
  wire [15:0] add_stage2_add_1;  // ufix16_En4
  reg [15:0] add_final_reg;  // ufix16_En4
  wire [11:0] add_final_reg_conv;  // ufix12_En4
  reg [11:0] dataOut_2;  // ufix12_En4
  reg  vStartIn_reg;
  ...
  always @(posedge clk or posedge reset)
    begin : tapDelay_1_process
      if (reset == 1'b1) begin
        tapDelay_1_reg[0] <= 8'b00000000;
        tapDelay_1_reg[1] <= 8'b00000000;
      end
      else begin
  ...
  always @(posedge clk or posedge reset)
    begin : tapDelay_3_process
      if (reset == 1'b1) begin
        tapDelay_3_reg[0] <= 8'b00000000;
        tapDelay_3_reg[1] <= 8'b00000000;
      end
      else begin
        if (enb && processData) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_final_process
      if (reset == 1'b1) begin
        preAdd1_final_reg <= 10'b0000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay1_process
      if (reset == 1'b1) begin
        multInDelay1_reg[0] <= 10'b0000000000;
        multInDelay1_reg[1] <= 10'b0000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay1_process
      if (reset == 1'b1) begin
        multOutDelay1_reg[0] <= 14'b00000000000000;
        multOutDelay1_reg[1] <= 14'b00000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage1_1_reg_process
      if (reset == 1'b1) begin
        add_stage1_1 <= 14'b00000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign adder_10 = {1'b0, preAdd2_stage1_1};
  assign adder_11 = {1'b0, preAdd2_stage1_2};
  ...
  assign adder_13 = {1'b0, preAdd2_stage1_3};
  assign adder_14 = {1'b0, preAdd2_stage1_4};
  ...
  assign adder_16 = {1'b0, preAdd2_stage2_1};
  assign adder_17 = {1'b0, preAdd2_stage2_2};
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd2_final_process
      if (reset == 1'b1) begin
        preAdd2_final_reg <= 10'b0000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay2_process
      if (reset == 1'b1) begin
        multInDelay2_reg[0] <= 10'b0000000000;
        multInDelay2_reg[1] <= 10'b0000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay2_process
      if (reset == 1'b1) begin
        multOutDelay2_reg[0] <= 14'b00000000000000;
        multOutDelay2_reg[1] <= 14'b00000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage1_2_reg_process
      if (reset == 1'b1) begin
        add_stage1_2 <= 14'b00000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign adder_add_cast = {1'b0, add_stage1_1};
  assign adder_add_cast_1 = {1'b0, add_stage1_2};
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage2_1_reg_process
      if (reset == 1'b1) begin
        add_stage2_1 <= 15'b000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd3_balance_process
      if (reset == 1'b1) begin
        preAdd3_balance_reg[0] <= 8'b00000000;
        preAdd3_balance_reg[1] <= 8'b00000000;
        preAdd3_balance_reg[2] <= 8'b00000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multInDelay3_process
      if (reset == 1'b1) begin
        multInDelay3_reg[0] <= 8'b00000000;
        multInDelay3_reg[1] <= 8'b00000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : multOutDelay3_process
      if (reset == 1'b1) begin
        multOutDelay3_reg[0] <= 12'b000000000000;
        multOutDelay3_reg[1] <= 12'b000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : add_stage2_2_reg_process
      if (reset == 1'b1) begin
        add_stage2_2_reg_reg[0] <= 12'b000000000000;
        add_stage2_2_reg_reg[1] <= 12'b000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign adder_add_cast_2 = {1'b0, add_stage2_1};
  assign adder_add_cast_3 = {4'b0, add_stage2_2};
  assign add_stage2_add_1 = adder_add_cast_2 + adder_add_cast_3;
  ...
  always @(posedge clk or posedge reset)
    begin : add_final_process
      if (reset == 1'b1) begin
        add_final_reg <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign add_final_reg_conv = (add_final_reg[15:12] != 4'b0000 ? 12'b111111111111 :
              add_final_reg[11:0]);
