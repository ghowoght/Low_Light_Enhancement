// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\Horizontal_Padder.v
...
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter4/LineBuffer/Horizontal Padder
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Horizontal_Padder
  ...
  input   padShift;
  output  [23:0] dataVector_0;  // ufix24_En16
  output  [23:0] dataVector_1;  // ufix24_En16
  output  [23:0] dataVector_2;  // ufix24_En16


  wire [23:0] DataMuxIn1 [0:2];  // ufix24_En16 [3]
  reg [23:0] intdelay_reg [0:2];  // ufix24 [3]
  wire [23:0] intdelay_reg_next [0:2];  // ufix24_En16 [3]
  wire [23:0] DataMuxIn1_1 [0:2];  // ufix24_En16 [3]
  reg [23:0] intdelay_reg_1 [0:2];  // ufix24 [3]
  wire [23:0] intdelay_reg_next_1 [0:2];  // ufix24_En16 [3]
  wire [23:0] DataMuxIn2 [0:2];  // ufix24_En16 [3]
  reg [23:0] intdelay_reg_2 [0:2];  // ufix24 [3]
  wire [23:0] intdelay_reg_next_2 [0:2];  // ufix24_En16 [3]
  wire [23:0] DataMuxIn3 [0:2];  // ufix24_En16 [3]
  reg [23:0] intdelay_reg_3 [0:2];  // ufix24 [3]
  wire [23:0] intdelay_reg_next_3 [0:2];  // ufix24_En16 [3]
  wire [23:0] DataMuxIn4 [0:2];  // ufix24_En16 [3]
  wire [23:0] dataVector [0:2];  // ufix24_En16 [3]
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_1_process
      if (reset == 1'b1) begin
        intdelay_reg_1[0] <= 24'b000000000000000000000000;
        intdelay_reg_1[1] <= 24'b000000000000000000000000;
        intdelay_reg_1[2] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb && padShift) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_2_process
      if (reset == 1'b1) begin
        intdelay_reg_2[0] <= 24'b000000000000000000000000;
        intdelay_reg_2[1] <= 24'b000000000000000000000000;
        intdelay_reg_2[2] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb && padShift) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_3_process
      if (reset == 1'b1) begin
        intdelay_reg_3[0] <= 24'b000000000000000000000000;
        intdelay_reg_3[1] <= 24'b000000000000000000000000;
        intdelay_reg_3[2] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb && padShift) begin
