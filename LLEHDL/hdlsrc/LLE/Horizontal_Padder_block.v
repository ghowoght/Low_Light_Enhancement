// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\Horizontal_Padder_block.v
...
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter3/LineBuffer/Horizontal Padder
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Horizontal_Padder_block
  ...
  input   padShift;
  output  [19:0] dataVector_0;  // ufix20_En12
  output  [19:0] dataVector_1;  // ufix20_En12
  output  [19:0] dataVector_2;  // ufix20_En12


  wire [19:0] DataMuxIn1 [0:2];  // ufix20_En12 [3]
  reg [19:0] intdelay_reg [0:2];  // ufix20 [3]
  wire [19:0] intdelay_reg_next [0:2];  // ufix20_En12 [3]
  wire [19:0] DataMuxIn1_1 [0:2];  // ufix20_En12 [3]
  reg [19:0] intdelay_reg_1 [0:2];  // ufix20 [3]
  wire [19:0] intdelay_reg_next_1 [0:2];  // ufix20_En12 [3]
  wire [19:0] DataMuxIn2 [0:2];  // ufix20_En12 [3]
  reg [19:0] intdelay_reg_2 [0:2];  // ufix20 [3]
  wire [19:0] intdelay_reg_next_2 [0:2];  // ufix20_En12 [3]
  wire [19:0] DataMuxIn3 [0:2];  // ufix20_En12 [3]
  reg [19:0] intdelay_reg_3 [0:2];  // ufix20 [3]
  wire [19:0] intdelay_reg_next_3 [0:2];  // ufix20_En12 [3]
  wire [19:0] DataMuxIn4 [0:2];  // ufix20_En12 [3]
  wire [19:0] dataVector [0:2];  // ufix20_En12 [3]
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_process
      if (reset == 1'b1) begin
        intdelay_reg[0] <= 20'b00000000000000000000;
        intdelay_reg[1] <= 20'b00000000000000000000;
        intdelay_reg[2] <= 20'b00000000000000000000;
      end
      else begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_1_process
      if (reset == 1'b1) begin
        intdelay_reg_1[0] <= 20'b00000000000000000000;
        intdelay_reg_1[1] <= 20'b00000000000000000000;
        intdelay_reg_1[2] <= 20'b00000000000000000000;
      end
      else begin
        if (enb && padShift) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_2_process
      if (reset == 1'b1) begin
        intdelay_reg_2[0] <= 20'b00000000000000000000;
        intdelay_reg_2[1] <= 20'b00000000000000000000;
        intdelay_reg_2[2] <= 20'b00000000000000000000;
      end
      else begin
        if (enb && padShift) begin
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_3_process
      if (reset == 1'b1) begin
        intdelay_reg_3[0] <= 20'b00000000000000000000;
        intdelay_reg_3[1] <= 20'b00000000000000000000;
        intdelay_reg_3[2] <= 20'b00000000000000000000;
      end
      else begin
        if (enb && padShift) begin
