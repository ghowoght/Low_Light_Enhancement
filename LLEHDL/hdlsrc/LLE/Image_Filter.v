// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\Image_Filter.v
...
// 
// Module: Image_Filter
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter
// Hierarchy Level: 2
// 
// Image Filter
// 
...
module Image_Filter
  ...
  wire LMKvalidOut;
  wire LMKprocessOut;
  wire [11:0] preFilterDataOut;  // ufix12_En4
  wire prehStartOut;
  wire prehEndOut;
  wire prevStartOut;
  wire prevEndOut;
  wire preValidOut;
  wire [11:0] zeroOut_1;  // ufix12_En4
  wire [11:0] preDataOut;  // ufix12_En4
  reg [11:0] intdelay_reg [0:3];  // ufix12 [4]
  wire [11:0] intdelay_reg_next [0:3];  // ufix12_En4 [4]
  wire [11:0] dataOut;  // ufix12_En4
  ...
  LineBuffer_block3 u_LineBuffer (.clk(clk),
                                  .reset(reset),
                                  .enb(enb),
  ...
  FIR2DKernel_block3 u_imagekernel_inst (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
                                         ...
                                         .dataOut(preFilterDataOut),  // ufix12_En4
  ...
  assign zeroOut_1 = 12'b000000000000;
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_process
      if (reset == 1'b1) begin
        ...
        intdelay_reg[3] <= 12'b000000000000;
      end
      else begin
        if (enb) begin
