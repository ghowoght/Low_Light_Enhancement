// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\Image_Filter2.v
...
// -------------------------------------------------------------
// 
// Module: Image_Filter2
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter2
// Hierarchy Level: 2
// 
// Image Filter
// 
...
module Image_Filter2
  ...
  input   reset;
  input   enb;
  input   [15:0] in0;  // ufix16_En8
  input   in1_hStart;
  input   in1_hEnd;
  input   in1_vStart;
  input   in1_vEnd;
  input   in1_valid;
  output  [19:0] out0;  // ufix20_En12
  output  out1_hStart;
  output  out1_hEnd;
  output  out1_vStart;
  output  out1_vEnd;
  ...
  reg [15:0] dataInReg;  // ufix16_En8
  reg  hStartInReg;
  reg  hendInReg;
  reg  vStartInReg;
  reg  vendInReg;
  reg  validInReg;
  wire [15:0] LMKDataOut_0;  // ufix16_En8
  wire [15:0] LMKDataOut_1;  // ufix16_En8
  wire [15:0] LMKDataOut_2;  // ufix16_En8
  wire LMKhStartOut;
  wire LMKhEndOut;
  wire LMKvStartOut;
  wire LMKvEndOut;
  wire LMKvalidOut;
  wire LMKprocessOut;
  wire [19:0] preFilterDataOut;  // ufix20_En12
  wire prehStartOut;
  wire prehEndOut;
  wire prevStartOut;
  wire prevEndOut;
  wire preValidOut;
  wire [19:0] zeroOut_1;  // ufix20_En12
  wire [19:0] preDataOut;  // ufix20_En12
  reg [19:0] intdelay_reg [0:3];  // ufix20 [4]
  wire [19:0] intdelay_reg_next [0:3];  // ufix20_En12 [4]
  wire [19:0] dataOut;  // ufix20_En12
  ...
  LineBuffer_block1 u_LineBuffer (.clk(clk),
                                  .reset(reset),
                                  .enb(enb),
                                  .dataIn(dataInReg),  // ufix16_En8
                                  .hStartIn(hStartInReg),
                                  .hEndIn(hendInReg),
                                  .vStartIn(vStartInReg),
                                  .vEndIn(vendInReg),
                                  .validIn(validInReg),
                                  .dataOut_0(LMKDataOut_0),  // ufix16_En8
                                  .dataOut_1(LMKDataOut_1),  // ufix16_En8
                                  .dataOut_2(LMKDataOut_2),  // ufix16_En8
  ...
  FIR2DKernel_block1 u_imagekernel_inst (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
                                         .dataIn_0(LMKDataOut_0),  // ufix16_En8
                                         .dataIn_1(LMKDataOut_1),  // ufix16_En8
                                         .dataIn_2(LMKDataOut_2),  // ufix16_En8
                                         ...
                                         .dataOut(preFilterDataOut),  // ufix20_En12
  ...
  assign zeroOut_1 = 20'b00000000000000000000;
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_process
      if (reset == 1'b1) begin
        ...
        intdelay_reg[3] <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
