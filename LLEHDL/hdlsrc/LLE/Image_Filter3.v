// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\Image_Filter3.v
...
// -------------------------------------------------------------
// 
// Module: Image_Filter3
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter3
// Hierarchy Level: 2
// 
// Image Filter
// 
...
module Image_Filter3
  ...
  input   reset;
  input   enb;
  input   [19:0] in0;  // ufix20_En12
  input   in1_hStart;
  input   in1_hEnd;
  input   in1_vStart;
  input   in1_vEnd;
  input   in1_valid;
  output  [23:0] out0;  // ufix24_En16
  output  out1_hStart;
  output  out1_hEnd;
  output  out1_vStart;
  output  out1_vEnd;
  ...
  reg [19:0] dataInReg;  // ufix20_En12
  reg  hStartInReg;
  reg  hendInReg;
  reg  vStartInReg;
  reg  vendInReg;
  reg  validInReg;
  wire [19:0] LMKDataOut_0;  // ufix20_En12
  wire [19:0] LMKDataOut_1;  // ufix20_En12
  wire [19:0] LMKDataOut_2;  // ufix20_En12
  wire LMKhStartOut;
  wire LMKhEndOut;
  wire LMKvStartOut;
  wire LMKvEndOut;
  wire LMKvalidOut;
  wire LMKprocessOut;
  wire [23:0] preFilterDataOut;  // ufix24_En16
  wire prehStartOut;
  wire prehEndOut;
  wire prevStartOut;
  wire prevEndOut;
  wire preValidOut;
  wire [23:0] zeroOut_1;  // ufix24_En16
  wire [23:0] preDataOut;  // ufix24_En16
  reg [23:0] intdelay_reg [0:3];  // ufix24 [4]
  wire [23:0] intdelay_reg_next [0:3];  // ufix24_En16 [4]
  wire [23:0] dataOut;  // ufix24_En16
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_process
      if (reset == 1'b1) begin
        dataInReg <= 20'b00000000000000000000;
      end
      else begin
        if (enb) begin
          dataInReg <= in0;
  ...
  LineBuffer_block u_LineBuffer (.clk(clk),
                                 .reset(reset),
                                 .enb(enb),
                                 .dataIn(dataInReg),  // ufix20_En12
                                 .hStartIn(hStartInReg),
                                 .hEndIn(hendInReg),
                                 .vStartIn(vStartInReg),
                                 .vEndIn(vendInReg),
                                 .validIn(validInReg),
                                 .dataOut_0(LMKDataOut_0),  // ufix20_En12
                                 .dataOut_1(LMKDataOut_1),  // ufix20_En12
                                 .dataOut_2(LMKDataOut_2),  // ufix20_En12
  ...
  FIR2DKernel_block u_imagekernel_inst (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
                                        .dataIn_0(LMKDataOut_0),  // ufix20_En12
                                        .dataIn_1(LMKDataOut_1),  // ufix20_En12
                                        .dataIn_2(LMKDataOut_2),  // ufix20_En12
                                        ...
                                        .dataOut(preFilterDataOut),  // ufix24_En16
  ...
  assign zeroOut_1 = 24'b000000000000000000000000;
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_process
      if (reset == 1'b1) begin
        ...
        intdelay_reg[3] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
