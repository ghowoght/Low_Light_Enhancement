// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\Image_Filter4.v
...
// -------------------------------------------------------------
// 
// Module: Image_Filter4
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter4
// Hierarchy Level: 2
// 
// Image Filter
// 
...
module Image_Filter4
  ...
  input   reset;
  input   enb;
  input   [23:0] in0;  // ufix24_En16
  input   in1_hStart;
  input   in1_hEnd;
  input   in1_vStart;
  input   in1_vEnd;
  input   in1_valid;
  output  [27:0] out0;  // ufix28_En20
  output  out1_hStart;
  output  out1_hEnd;
  output  out1_vStart;
  output  out1_vEnd;
  ...
  reg [23:0] dataInReg;  // ufix24_En16
  reg  hStartInReg;
  reg  hendInReg;
  reg  vStartInReg;
  reg  vendInReg;
  reg  validInReg;
  wire [23:0] LMKDataOut_0;  // ufix24_En16
  wire [23:0] LMKDataOut_1;  // ufix24_En16
  wire [23:0] LMKDataOut_2;  // ufix24_En16
  wire LMKhStartOut;
  wire LMKhEndOut;
  wire LMKvStartOut;
  wire LMKvEndOut;
  wire LMKvalidOut;
  wire LMKprocessOut;
  wire [27:0] preFilterDataOut;  // ufix28_En20
  wire prehStartOut;
  wire prehEndOut;
  wire prevStartOut;
  wire prevEndOut;
  wire preValidOut;
  wire [27:0] zeroOut_1;  // ufix28_En20
  wire [27:0] preDataOut;  // ufix28_En20
  reg [27:0] intdelay_reg [0:3];  // ufix28 [4]
  wire [27:0] intdelay_reg_next [0:3];  // ufix28_En20 [4]
  wire [27:0] dataOut;  // ufix28_En20
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_process
      if (reset == 1'b1) begin
        dataInReg <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
          dataInReg <= in0;
  ...
  LineBuffer u_LineBuffer (.clk(clk),
                           .reset(reset),
                           .enb(enb),
                           .dataIn(dataInReg),  // ufix24_En16
                           .hStartIn(hStartInReg),
                           .hEndIn(hendInReg),
                           .vStartIn(vStartInReg),
                           .vEndIn(vendInReg),
                           .validIn(validInReg),
                           .dataOut_0(LMKDataOut_0),  // ufix24_En16
                           .dataOut_1(LMKDataOut_1),  // ufix24_En16
                           .dataOut_2(LMKDataOut_2),  // ufix24_En16
  ...
  FIR2DKernel u_imagekernel_inst (.clk(clk),
                                  .reset(reset),
                                  .enb(enb),
                                  .dataIn_0(LMKDataOut_0),  // ufix24_En16
                                  .dataIn_1(LMKDataOut_1),  // ufix24_En16
                                  .dataIn_2(LMKDataOut_2),  // ufix24_En16
                                  ...
                                  .dataOut(preFilterDataOut),  // ufix28_En20
  ...
  assign zeroOut_1 = 28'b0000000000000000000000000000;
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_process
      if (reset == 1'b1) begin
        intdelay_reg[0] <= 28'b0000000000000000000000000000;
        intdelay_reg[1] <= 28'b0000000000000000000000000000;
        intdelay_reg[2] <= 28'b0000000000000000000000000000;
        intdelay_reg[3] <= 28'b0000000000000000000000000000;
      end
      else begin
        if (enb) begin
