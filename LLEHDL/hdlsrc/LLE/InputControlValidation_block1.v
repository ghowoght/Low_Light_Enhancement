// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\InputControlValidation_block1.v
...
// -------------------------------------------------------------
// 
// Module: InputControlValidation_block1
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter2/LineBuffer/InputControlValidation
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module InputControlValidation_block1
  ...
  wire LineBufferNotInLine;  // ufix1
  wire LineBufferInBetween;  // ufix1
  reg  InBetweenOut_1;
  ...
  assign LineBufferNotInLine =  ~ LineBufferinLine;



  assign LineBufferInBetween = LineBufferNotInLine & LineBufferinFrame;
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_3_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          InBetweenOut_1 <= LineBufferInBetween;
        end
      end
    end
  ...
  assign InBetweenOut = InBetweenOut_1;

endmodule  // InputControlValidation_block1
