// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\LineBuffer.v
...
// 
// Module: LineBuffer
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter4/LineBuffer
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module LineBuffer
  ...
  input   reset;
  input   enb;
  input   [23:0] dataIn;  // ufix24_En16
  input   hStartIn;
  input   hEndIn;
  input   vStartIn;
  input   vEndIn;
  input   validIn;
  output  [23:0] dataOut_0;  // ufix24_En16
  output  [23:0] dataOut_1;  // ufix24_En16
  output  [23:0] dataOut_2;  // ufix24_En16
  output  hStartOut;
  output  hEndOut;
  output  vStartOut;
  output  vEndOut;
  ...
  reg [23:0] intdelay_reg_6 [0:3];  // ufix24 [4]
  wire [23:0] intdelay_reg_next_6 [0:3];  // ufix24_En16 [4]
  wire [23:0] dataInREG;  // ufix24_En16
  ...
  reg  hStartDRC;
  reg  vEndRREG;
  wire [23:0] DataMemVector_0;  // ufix24_En16
  wire [23:0] DataMemVector_1;  // ufix24_En16
  wire [23:0] DataMemVector_2;  // ufix24_En16
  wire popReg;
  wire AllEndOfLine;
  reg  AllEndOfLineREG;
  wire vEndR;
  ...
  wire Running;
  reg  outputDataREG;
  wire [23:0] constZero [0:2];  // ufix24_En16 [3]
  wire runOrUnload;
  ...
  wire outputProcess;
  wire padShift;
  wire [23:0] DataMemVector [0:2];  // ufix24_En16 [3]
  reg [23:0] intdelay_reg_9 [0:2];  // ufix24 [3]
  wire [23:0] intdelay_reg_next_9 [0:2];  // ufix24_En16 [3]
  wire [23:0] DataMemVectorREG [0:2];  // ufix24_En16 [3]
  wire countEnHC_1;
  reg [10:0] horPadCount;  // ufix11
  reg [10:0] horPadCountREG;  // ufix11
  wire [23:0] DataMemVectorPadded_0;  // ufix24_En16
  wire [23:0] DataMemVectorPadded_1;  // ufix24_En16
  wire [23:0] DataMemVectorPadded_2;  // ufix24_En16
  wire [10:0] VerCountOut;  // ufix11
  wire [23:0] verPadOut_0;  // ufix24_En16
  wire [23:0] verPadOut_1;  // ufix24_En16
  wire [23:0] verPadOut_2;  // ufix24_En16
  wire [23:0] verPadOut [0:2];  // ufix24_En16 [3]
  reg [23:0] reg_reg [0:2];  // ufix24 [3]
  wire [23:0] reg_reg_next [0:2];  // ufix24_En16 [3]
  wire [23:0] verPadD [0:2];  // ufix24_En16 [3]
  wire [23:0] dataSigOut [0:2];  // ufix24_En16 [3]
  reg [23:0] reg_reg_1 [0:2];  // ufix24 [3]
  wire [23:0] reg_reg_next_1 [0:2];  // ufix24_En16 [3]
  wire [23:0] dataSigPreOD [0:2];  // ufix24_En16 [3]
  wire [23:0] dataOut [0:2];  // ufix24_En16 [3]
  wire ctrlOutZero;
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_6_process
      if (reset == 1'b1) begin
        intdelay_reg_6[0] <= 24'b000000000000000000000000;
        intdelay_reg_6[1] <= 24'b000000000000000000000000;
        intdelay_reg_6[2] <= 24'b000000000000000000000000;
        intdelay_reg_6[3] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  DATA_MEMORY u_DATA_MEMORY (.clk(clk),
                             ...
                             .validIn(validRREG),
                             .popEn(popEn),  // ufix2
                             .dataVectorOut_0(DataMemVector_0),  // ufix24_En16
                             .dataVectorOut_1(DataMemVector_1),  // ufix24_En16
                             .dataVectorOut_2(DataMemVector_2),  // ufix24_En16
                             .popOut(popReg),
  ...
  assign constZero[0] = 24'b000000000000000000000000;
  assign constZero[1] = 24'b000000000000000000000000;
  assign constZero[2] = 24'b000000000000000000000000;
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_9_process
      if (reset == 1'b1) begin
        intdelay_reg_9[0] <= 24'b000000000000000000000000;
        intdelay_reg_9[1] <= 24'b000000000000000000000000;
        intdelay_reg_9[2] <= 24'b000000000000000000000000;
      end
      else begin
  ...
  Horizontal_Padder u_Horizontal_Padder (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
                                         .dataVectorIn_0(DataMemVectorREG[0]),  // ufix24_En16
                                         .dataVectorIn_1(DataMemVectorREG[1]),  // ufix24_En16
                                         .dataVectorIn_2(DataMemVectorREG[2]),  // ufix24_En16
                                         .horPadCount(horPadCountREG),  // ufix11
                                         .padShift(padShift),
                                         .dataVector_0(DataMemVectorPadded_0),  // ufix24_En16
                                         .dataVector_1(DataMemVectorPadded_1),  // ufix24_En16
                                         .dataVector_2(DataMemVectorPadded_2)  // ufix24_En16
                                         );

  Vertical_Padding_Counter u_Vertical_Counter (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
                                               .frameEnd(vStartIn),
                                               .unloading(unloading),
  ...
  Vertical_Padder u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // ufix24_En16
                                     .dataVectorIn_1(DataMemVectorPadded_1),  // ufix24_En16
                                     .dataVectorIn_2(DataMemVectorPadded_2),  // ufix24_En16
                                     .verPadCount(VerCountOut),  // ufix11
                                     .dataVectorOut_0(verPadOut_0),  // ufix24_En16
                                     .dataVectorOut_1(verPadOut_1),  // ufix24_En16
                                     .dataVectorOut_2(verPadOut_2)  // ufix24_En16
                                     );
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_14_process
      if (reset == 1'b1) begin
        reg_reg[0] <= 24'b000000000000000000000000;
        reg_reg[1] <= 24'b000000000000000000000000;
        reg_reg[2] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_15_process
      if (reset == 1'b1) begin
        reg_reg_1[0] <= 24'b000000000000000000000000;
        reg_reg_1[1] <= 24'b000000000000000000000000;
        reg_reg_1[2] <= 24'b000000000000000000000000;
      end
      else begin
        if (enb) begin
