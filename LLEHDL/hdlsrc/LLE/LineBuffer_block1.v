// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\LineBuffer_block1.v
...
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter2/LineBuffer
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module LineBuffer_block1
  ...
  input   reset;
  input   enb;
  input   [15:0] dataIn;  // ufix16_En8
  input   hStartIn;
  input   hEndIn;
  input   vStartIn;
  input   vEndIn;
  input   validIn;
  output  [15:0] dataOut_0;  // ufix16_En8
  output  [15:0] dataOut_1;  // ufix16_En8
  output  [15:0] dataOut_2;  // ufix16_En8
  output  hStartOut;
  output  hEndOut;
  output  vStartOut;
  output  vEndOut;
  ...
  reg [15:0] intdelay_reg_6 [0:3];  // ufix16 [4]
  wire [15:0] intdelay_reg_next_6 [0:3];  // ufix16_En8 [4]
  wire [15:0] dataInREG;  // ufix16_En8
  ...
  reg  hStartDRC;
  reg  vEndRREG;
  wire [15:0] DataMemVector_0;  // ufix16_En8
  wire [15:0] DataMemVector_1;  // ufix16_En8
  wire [15:0] DataMemVector_2;  // ufix16_En8
  wire popReg;
  wire AllEndOfLine;
  reg  AllEndOfLineREG;
  wire vEndR;
  ...
  wire Running;
  reg  outputDataREG;
  wire [15:0] constZero [0:2];  // ufix16_En8 [3]
  wire runOrUnload;
  ...
  wire outputProcess;
  wire padShift;
  wire [15:0] DataMemVector [0:2];  // ufix16_En8 [3]
  reg [15:0] intdelay_reg_9 [0:2];  // ufix16 [3]
  wire [15:0] intdelay_reg_next_9 [0:2];  // ufix16_En8 [3]
  wire [15:0] DataMemVectorREG [0:2];  // ufix16_En8 [3]
  wire countEnHC_1;
  reg [10:0] horPadCount;  // ufix11
  reg [10:0] horPadCountREG;  // ufix11
  wire [15:0] DataMemVectorPadded_0;  // ufix16_En8
  wire [15:0] DataMemVectorPadded_1;  // ufix16_En8
  wire [15:0] DataMemVectorPadded_2;  // ufix16_En8
  wire [10:0] VerCountOut;  // ufix11
  wire [15:0] verPadOut_0;  // ufix16_En8
  wire [15:0] verPadOut_1;  // ufix16_En8
  wire [15:0] verPadOut_2;  // ufix16_En8
  wire [15:0] verPadOut [0:2];  // ufix16_En8 [3]
  reg [15:0] reg_reg [0:2];  // ufix16 [3]
  wire [15:0] reg_reg_next [0:2];  // ufix16_En8 [3]
  wire [15:0] verPadD [0:2];  // ufix16_En8 [3]
  wire [15:0] dataSigOut [0:2];  // ufix16_En8 [3]
  reg [15:0] reg_reg_1 [0:2];  // ufix16 [3]
  wire [15:0] reg_reg_next_1 [0:2];  // ufix16_En8 [3]
  wire [15:0] dataSigPreOD [0:2];  // ufix16_En8 [3]
  wire [15:0] dataOut [0:2];  // ufix16_En8 [3]
  wire ctrlOutZero;
  ...
  InputControlValidation_block1 u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartInD),
                                                            .hEndIn(hEndInD),
  ...
  LineSpaceAverager_block1 u_LineSpaceAverager (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_6_process
      if (reset == 1'b1) begin
        intdelay_reg_6[0] <= 16'b0000000000000000;
        intdelay_reg_6[1] <= 16'b0000000000000000;
        intdelay_reg_6[2] <= 16'b0000000000000000;
        intdelay_reg_6[3] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  DATA_MEMORY_block1 u_DATA_MEMORY (.clk(clk),
                                    .reset(reset),
                                    .enb(enb),
                                    .Unloading(unloading),
                                    .pixelIn(dataInREG),  // ufix16_En8
                                    .hStartIn(hStartDRC),
                                    .hEndIn(hEndRREG),
                                    .vStartIn(vStartDRC),
                                    .vEndIn(vEndRREG),
                                    .validIn(validRREG),
                                    .popEn(popEn),  // ufix2
                                    .dataVectorOut_0(DataMemVector_0),  // ufix16_En8
                                    .dataVectorOut_1(DataMemVector_1),  // ufix16_En8
                                    .dataVectorOut_2(DataMemVector_2),  // ufix16_En8
                                    .popOut(popReg),
  ...
  LineInfoStore_block3 u_LINE_INFO_STORE (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .hStartIn(hStartDRC),
                                          .Unloading(unloading),
  ...
  DataReadController_block1 u_DATA_READ_CONTROLLER (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .hStartIn(hStartVREG),
                                                    .hEndIn(hEndV_1),
  ...
  assign constZero[0] = 16'b0000000000000000;
  assign constZero[1] = 16'b0000000000000000;
  assign constZero[2] = 16'b0000000000000000;
  ...
  LineInfoStore_block4 u_State_Transition_Flag_Gen (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .hStartIn(hStartDRC),
                                                    .hEndIn(hEndRDT),
  ...
  PaddingController_block1 u_Padding_Controller (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
                                                 .PrePadFlag(PrePadFlag),
                                                 .OnLineFlag(OnLineFlag),
  ...
  GateProcessData_block1 u_Gate_Process_Data (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_9_process
      if (reset == 1'b1) begin
        intdelay_reg_9[0] <= 16'b0000000000000000;
        intdelay_reg_9[1] <= 16'b0000000000000000;
        intdelay_reg_9[2] <= 16'b0000000000000000;
      end
      else begin
  ...
  Horizontal_Padder_block1 u_Horizontal_Padder (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .dataVectorIn_0(DataMemVectorREG[0]),  // ufix16_En8
                                                .dataVectorIn_1(DataMemVectorREG[1]),  // ufix16_En8
                                                .dataVectorIn_2(DataMemVectorREG[2]),  // ufix16_En8
                                                .horPadCount(horPadCountREG),  // ufix11
                                                .padShift(padShift),
                                                .dataVector_0(DataMemVectorPadded_0),  // ufix16_En8
                                                .dataVector_1(DataMemVectorPadded_1),  // ufix16_En8
                                                .dataVector_2(DataMemVectorPadded_2)  // ufix16_En8
                                                );

  Vertical_Padding_Counter_block1 u_Vertical_Counter (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .frameEnd(vStartIn),
                                                      .unloading(unloading),
  ...
  Vertical_Padder_block1 u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // ufix16_En8
                                            .dataVectorIn_1(DataMemVectorPadded_1),  // ufix16_En8
                                            .dataVectorIn_2(DataMemVectorPadded_2),  // ufix16_En8
                                            .verPadCount(VerCountOut),  // ufix11
                                            .dataVectorOut_0(verPadOut_0),  // ufix16_En8
                                            .dataVectorOut_1(verPadOut_1),  // ufix16_En8
                                            .dataVectorOut_2(verPadOut_2)  // ufix16_En8
                                            );
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_14_process
      if (reset == 1'b1) begin
        reg_reg[0] <= 16'b0000000000000000;
        reg_reg[1] <= 16'b0000000000000000;
        reg_reg[2] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_15_process
      if (reset == 1'b1) begin
        reg_reg_1[0] <= 16'b0000000000000000;
        reg_reg_1[1] <= 16'b0000000000000000;
        reg_reg_1[2] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
