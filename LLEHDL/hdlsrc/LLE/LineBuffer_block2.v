// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\LineBuffer_block2.v
...
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter1/LineBuffer
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module LineBuffer_block2
  ...
  input   reset;
  input   enb;
  input   [11:0] dataIn;  // ufix12_En4
  input   hStartIn;
  input   hEndIn;
  input   vStartIn;
  input   vEndIn;
  input   validIn;
  output  [11:0] dataOut_0;  // ufix12_En4
  output  [11:0] dataOut_1;  // ufix12_En4
  output  [11:0] dataOut_2;  // ufix12_En4
  output  hStartOut;
  output  hEndOut;
  output  vStartOut;
  output  vEndOut;
  ...
  reg [11:0] intdelay_reg_6 [0:3];  // ufix12 [4]
  wire [11:0] intdelay_reg_next_6 [0:3];  // ufix12_En4 [4]
  wire [11:0] dataInREG;  // ufix12_En4
  ...
  reg  hStartDRC;
  reg  vEndRREG;
  wire [11:0] DataMemVector_0;  // ufix12_En4
  wire [11:0] DataMemVector_1;  // ufix12_En4
  wire [11:0] DataMemVector_2;  // ufix12_En4
  wire popReg;
  wire AllEndOfLine;
  reg  AllEndOfLineREG;
  wire vEndR;
  ...
  wire Running;
  reg  outputDataREG;
  wire [11:0] constZero [0:2];  // ufix12_En4 [3]
  wire runOrUnload;
  ...
  wire outputProcess;
  wire padShift;
  wire [11:0] DataMemVector [0:2];  // ufix12_En4 [3]
  reg [11:0] intdelay_reg_9 [0:2];  // ufix12 [3]
  wire [11:0] intdelay_reg_next_9 [0:2];  // ufix12_En4 [3]
  wire [11:0] DataMemVectorREG [0:2];  // ufix12_En4 [3]
  wire countEnHC_1;
  reg [10:0] horPadCount;  // ufix11
  reg [10:0] horPadCountREG;  // ufix11
  wire [11:0] DataMemVectorPadded_0;  // ufix12_En4
  wire [11:0] DataMemVectorPadded_1;  // ufix12_En4
  wire [11:0] DataMemVectorPadded_2;  // ufix12_En4
  wire [10:0] VerCountOut;  // ufix11
  wire [11:0] verPadOut_0;  // ufix12_En4
  wire [11:0] verPadOut_1;  // ufix12_En4
  wire [11:0] verPadOut_2;  // ufix12_En4
  wire [11:0] verPadOut [0:2];  // ufix12_En4 [3]
  reg [11:0] reg_reg [0:2];  // ufix12 [3]
  wire [11:0] reg_reg_next [0:2];  // ufix12_En4 [3]
  wire [11:0] verPadD [0:2];  // ufix12_En4 [3]
  wire [11:0] dataSigOut [0:2];  // ufix12_En4 [3]
  reg [11:0] reg_reg_1 [0:2];  // ufix12 [3]
  wire [11:0] reg_reg_next_1 [0:2];  // ufix12_En4 [3]
  wire [11:0] dataSigPreOD [0:2];  // ufix12_En4 [3]
  wire [11:0] dataOut [0:2];  // ufix12_En4 [3]
  wire ctrlOutZero;
  ...
  InputControlValidation_block2 u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartInD),
                                                            .hEndIn(hEndInD),
  ...
  LineSpaceAverager_block2 u_LineSpaceAverager (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_6_process
      if (reset == 1'b1) begin
        intdelay_reg_6[0] <= 12'b000000000000;
        intdelay_reg_6[1] <= 12'b000000000000;
        intdelay_reg_6[2] <= 12'b000000000000;
        intdelay_reg_6[3] <= 12'b000000000000;
      end
      else begin
        if (enb) begin
  ...
  DATA_MEMORY_block2 u_DATA_MEMORY (.clk(clk),
                                    .reset(reset),
                                    .enb(enb),
                                    .Unloading(unloading),
                                    .pixelIn(dataInREG),  // ufix12_En4
                                    .hStartIn(hStartDRC),
                                    .hEndIn(hEndRREG),
                                    .vStartIn(vStartDRC),
                                    .vEndIn(vEndRREG),
                                    .validIn(validRREG),
                                    .popEn(popEn),  // ufix2
                                    .dataVectorOut_0(DataMemVector_0),  // ufix12_En4
                                    .dataVectorOut_1(DataMemVector_1),  // ufix12_En4
                                    .dataVectorOut_2(DataMemVector_2),  // ufix12_En4
                                    .popOut(popReg),
  ...
  LineInfoStore_block5 u_LINE_INFO_STORE (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .hStartIn(hStartDRC),
                                          .Unloading(unloading),
  ...
  DataReadController_block2 u_DATA_READ_CONTROLLER (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .hStartIn(hStartVREG),
                                                    .hEndIn(hEndV_1),
  ...
  assign constZero[0] = 12'b000000000000;
  assign constZero[1] = 12'b000000000000;
  assign constZero[2] = 12'b000000000000;
  ...
  LineInfoStore_block6 u_State_Transition_Flag_Gen (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .hStartIn(hStartDRC),
                                                    .hEndIn(hEndRDT),
  ...
  PaddingController_block2 u_Padding_Controller (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
                                                 .PrePadFlag(PrePadFlag),
                                                 .OnLineFlag(OnLineFlag),
  ...
  GateProcessData_block2 u_Gate_Process_Data (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_9_process
      if (reset == 1'b1) begin
        intdelay_reg_9[0] <= 12'b000000000000;
        intdelay_reg_9[1] <= 12'b000000000000;
        intdelay_reg_9[2] <= 12'b000000000000;
      end
      else begin
  ...
  Horizontal_Padder_block2 u_Horizontal_Padder (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .dataVectorIn_0(DataMemVectorREG[0]),  // ufix12_En4
                                                .dataVectorIn_1(DataMemVectorREG[1]),  // ufix12_En4
                                                .dataVectorIn_2(DataMemVectorREG[2]),  // ufix12_En4
                                                .horPadCount(horPadCountREG),  // ufix11
                                                .padShift(padShift),
                                                .dataVector_0(DataMemVectorPadded_0),  // ufix12_En4
                                                .dataVector_1(DataMemVectorPadded_1),  // ufix12_En4
                                                .dataVector_2(DataMemVectorPadded_2)  // ufix12_En4
                                                );

  Vertical_Padding_Counter_block2 u_Vertical_Counter (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .frameEnd(vStartIn),
                                                      .unloading(unloading),
  ...
  Vertical_Padder_block2 u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // ufix12_En4
                                            .dataVectorIn_1(DataMemVectorPadded_1),  // ufix12_En4
                                            .dataVectorIn_2(DataMemVectorPadded_2),  // ufix12_En4
                                            .verPadCount(VerCountOut),  // ufix11
                                            .dataVectorOut_0(verPadOut_0),  // ufix12_En4
                                            .dataVectorOut_1(verPadOut_1),  // ufix12_En4
                                            .dataVectorOut_2(verPadOut_2)  // ufix12_En4
                                            );
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_14_process
      if (reset == 1'b1) begin
        reg_reg[0] <= 12'b000000000000;
        reg_reg[1] <= 12'b000000000000;
        reg_reg[2] <= 12'b000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_15_process
      if (reset == 1'b1) begin
        reg_reg_1[0] <= 12'b000000000000;
        reg_reg_1[1] <= 12'b000000000000;
        reg_reg_1[2] <= 12'b000000000000;
      end
      else begin
        if (enb) begin
