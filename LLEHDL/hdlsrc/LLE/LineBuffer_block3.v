// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\LineBuffer_block3.v
...
// -------------------------------------------------------------
// 
// Module: LineBuffer_block3
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter/LineBuffer
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module LineBuffer_block3
  ...
  InputControlValidation_block3 u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartInD),
                                                            .hEndIn(hEndInD),
  ...
  LineSpaceAverager_block3 u_LineSpaceAverager (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
  ...
  DATA_MEMORY_block3 u_DATA_MEMORY (.clk(clk),
                                    .reset(reset),
                                    .enb(enb),
                                    .Unloading(unloading),
  ...
  LineInfoStore_block7 u_LINE_INFO_STORE (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .hStartIn(hStartDRC),
                                          .Unloading(unloading),
  ...
  DataReadController_block3 u_DATA_READ_CONTROLLER (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .hStartIn(hStartVREG),
                                                    .hEndIn(hEndV_1),
  ...
  LineInfoStore_block8 u_State_Transition_Flag_Gen (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .hStartIn(hStartDRC),
                                                    .hEndIn(hEndRDT),
  ...
  PaddingController_block3 u_Padding_Controller (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
                                                 .PrePadFlag(PrePadFlag),
                                                 .OnLineFlag(OnLineFlag),
  ...
  GateProcessData_block3 u_Gate_Process_Data (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  Horizontal_Padder_block3 u_Horizontal_Padder (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
  ...
  Vertical_Padding_Counter_block3 u_Vertical_Counter (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .frameEnd(vStartIn),
                                                      .unloading(unloading),
  ...
  Vertical_Padder_block3 u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // uint8
