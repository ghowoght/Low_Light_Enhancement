// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\LineInfoStore_block2.v
...
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter3/LineBuffer/LineInfoStore
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module LineInfoStore_block2
  ...
  always @(posedge clk or posedge reset)
    begin : alphaSignal_CtxName_LLE_RefNum_s18_UserName_validTemp2_RTTIClass_class_pir_Signal_Network_n31_process
      if (reset == 1'b1) begin
        hEndCentreTap <= 1'b0;
      end
      else begin
