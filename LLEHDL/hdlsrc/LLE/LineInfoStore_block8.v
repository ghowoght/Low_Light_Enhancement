// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\LineInfoStore_block8.v
...
// -------------------------------------------------------------
// 
// Module: LineInfoStore_block8
// Source Path: LLE/LLEHDL/IterativeFilter/Image Filter/LineBuffer/LineInfoStore
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module LineInfoStore_block8
  ...
  always @(posedge clk or posedge reset)
    begin : alphaSignal_CtxName_LLE_RefNum_s18_UserName_validTemp2_RTTIClass_class_pir_Signal_Network_n82_process
      if (reset == 1'b1) begin
        hEndCentreTap <= 1'b0;
      end
      else begin
...
endmodule  // LineInfoStore_block8
