// -------------------------------------------------------------
// 
// File Name: hdlsrc\LLE\Pixel_Stream_Aligner.v
...
// Source Path: LLE/LLEHDL/Pixel Stream Aligner
// Hierarchy Level: 1
// 
...
module Pixel_Stream_Aligner
  ...
  reg [12:0] line0Starts;  // ufix13
  reg [12:0] line1Starts;  // ufix13
  reg [12:0] line2Starts;  // ufix13
  reg [12:0] line3Starts;  // ufix13
  reg [12:0] line4Starts;  // ufix13
  reg [12:0] line5Starts;  // ufix13
  wire [12:0] linerddata;  // ufix13
  reg [12:0] frameStart;  // ufix13
  wire [12:0] RAMrdloadval;  // ufix13
  wire refEarlyInFrame;  // ufix1
  wire refEarlyInLine;  // ufix1
  wire [12:0] constone;  // ufix13
  reg [12:0] RAMrdaddr;  // ufix13
  wire [12:0] RAMrdnextaddr;  // ufix13
  wire relop_relop1;
  ...
  wire [29:0] refzeroconst_2;  // ufix30_En22
  reg [29:0] refpixelInReg;  // ufix30_En22
  reg [29:0] refpixdlyline_reg [0:7];  // ufix30 [8]
  wire [29:0] refpixdlyline_reg_next [0:7];  // ufix30_En22 [8]
  wire [29:0] refpixeldly;  // ufix30_En22
  wire [29:0] refpixelOutReg;  // ufix30_En22
  reg [29:0] refPixelOut;  // ufix30_En22
  ...
  always @(posedge clk or posedge reset)
    begin : wraddrcounter_process
      if (reset == 1'b1) begin
        RAMwraddr <= 13'b0000000000000;
      end
      else begin
        if (enb && RAMwren) begin
          RAMwraddr <= RAMwraddr + 13'b0000000000001;
        end
      end
    end
      ...
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (linerden == 1'b1) begin
            if (linerdaddr >= 3'b101) begin
              linerdaddr <= 3'b000;
            end
            else begin
              linerdaddr <= linerdaddr + 3'b001;
            end
          end
        end
      end
  ...
  assign linerd0addrdecode = linerdaddr == 3'b000;
  ...
  assign linerd1addrdecode = linerdaddr == 3'b001;
  ...
  assign linerd2addrdecode = linerdaddr == 3'b010;
  ...
  assign linerd3addrdecode = linerdaddr == 3'b011;
  ...
  assign linerd4addrdecode = linerdaddr == 3'b100;
  ...
  assign linerd5addrdecode = linerdaddr == 3'b101;
  ...
  assign linerdvalid = (linerdaddr == 3'b000 ? line0StartsValid :
              (linerdaddr == 3'b001 ? line1StartsValid :
              (linerdaddr == 3'b010 ? line2StartsValid :
              (linerdaddr == 3'b011 ? line3StartsValid :
              (linerdaddr == 3'b100 ? line4StartsValid :
              line5StartsValid)))));
  ...
  assign linerddata = (linerdaddr == 3'b000 ? line0Starts :
              (linerdaddr == 3'b001 ? line1Starts :
              (linerdaddr == 3'b010 ? line2Starts :
              (linerdaddr == 3'b011 ? line3Starts :
              (linerdaddr == 3'b100 ? line4Starts :
              line5Starts)))));
      ...
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          if (RAMrdload == 1'b1) begin
            ...
            RAMrdaddr <= RAMrdaddr + 13'b0000000000001;
          end
        end
      end
    end
  ...
  SimpleDualPortRAM_generic #(.AddrWidth(13),
                              .DataWidth(8)
                              )
                            u_pixelRAM_generic (.clk(clk),
                                                .enb(enb),
  ...
  assign refzeroconst_2 = 30'b000000000000000000000000000000;
  ...
  always @(posedge clk or posedge reset)
    begin : rpixelIReg_process
      if (reset == 1'b1) begin
        refpixelInReg <= 30'b000000000000000000000000000000;
      end
      else begin
        if (enb) begin
          refpixelInReg <= in2;
  ...
  always @(posedge clk or posedge reset)
    begin : refpixdlyline_process
      if (reset == 1'b1) begin
        refpixdlyline_reg[0] <= 30'b000000000000000000000000000000;
        refpixdlyline_reg[1] <= 30'b000000000000000000000000000000;
        refpixdlyline_reg[2] <= 30'b000000000000000000000000000000;
        refpixdlyline_reg[3] <= 30'b000000000000000000000000000000;
        refpixdlyline_reg[4] <= 30'b000000000000000000000000000000;
        refpixdlyline_reg[5] <= 30'b000000000000000000000000000000;
        refpixdlyline_reg[6] <= 30'b000000000000000000000000000000;
        refpixdlyline_reg[7] <= 30'b000000000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : refpixelOReg_process
      if (reset == 1'b1) begin
        refPixelOut <= 30'b000000000000000000000000000000;
      end
      else begin
        if (enb) begin
...
endmodule  // Pixel_Stream_Aligner
